...
public final class AzureClientConstants {
	...
	public static final String REGISTRY_BLUEPRINT_PD_PROP="docker.registry.bluePrint.password";
	...
	public static final String DOCKERVMPD_PROP="docker.dockerVMPassword";
	...
	public static final String REGISTRY_PD_PROP="docker.registry.password";
	...
	public static final String DOCKER_REGISTRY_PROBE_PD_PROP="docker.registry.probe.password";
	...
	public static final String NEXUS_REGISTY_PD="docker.nexusRegistyPwd";
