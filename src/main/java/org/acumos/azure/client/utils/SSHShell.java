...
public final class SSHShell {
	 ...
	 *
	 * @param fileName
	 *            the name of the file for which the content will be downloaded
	 * @param fromPath
	 *            the path of the file for which the content will be downloaded
	 * @param isUserHomeBased
	 *            true if the path of the file is relative to the user's home
	 *            directory
	 ...
	 * @param fileName
	 *            the name of the file for which the content will be saved into
	 * @param toPath
	 *            the path of the file for which the content will be saved into
	 * @param isUserHomeBased
	 *            true if the path of the file is relative to the user's home
	 *            directory
	 * @param filePerm
