...
public final class Utils {
    ...
    public static void print(VirtualMachine resource) {
        ...
        log.info(new StringBuilder().append("Virtual Machine: ").append(resource.id())
    ...
    public static void print(AvailabilitySet resource) {
        ...
        log.info(new StringBuilder().append("Availability Set: ").append(resource.id())
            .append("Name: ").append(resource.name())
            .append("\n\tResource group: ").append(resource.resourceGroupName())
            .append("\n\tRegion: ").append(resource.region())
            .append("\n\tTags: ").append(resource.tags())
    ...
    public static void print(PublicIPAddress resource) {
        log.info(new StringBuilder().append("Public IP Address: ").append(resource.id())
            .append("Name: ").append(resource.name())
            .append("\n\tResource group: ").append(resource.resourceGroupName())
            .append("\n\tRegion: ").append(resource.region())
            .append("\n\tTags: ").append(resource.tags())
    ...
    public static void print(List<StorageAccountKey> storageAccountKeys) {
        for (int i = 0; i < storageAccountKeys.size(); i++) {
            ...
            log.info("Key (" + i + ") " + storageAccountKey.keyName() + "="
    ...
    public static void print(BatchAccountKeys batchAccountKeys) {
        log.info("Primary Key (" + batchAccountKeys.primary() + ") Secondary key = ("
    ...
    public static void print(BatchAccount batchAccount) {
        ...
        log.info(new StringBuilder().append("BatchAccount: ").append(batchAccount.id())
    ...
    public static void print(VerificationIPFlow resource) {
        log.info(new StringBuilder("IP flow verification: ")
    ...
    public static void print(FlowLogSettings resource) {
        log.info(new StringBuilder().append("Flow log settings: ")
    ...
    public static void print(NextHop resource) {
        log.info(new StringBuilder("Next hop: ")
