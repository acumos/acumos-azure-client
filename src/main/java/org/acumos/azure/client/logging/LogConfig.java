...
===============LICENSE_END=========================================================
*/
package org.acumos.azure.client.logging;
...
public class LogConfig {
	public static void setEnteringMDCs(String targetEntry,String targetService,String requestIdName) throws Exception{
		String hostname="";
        String ip="";
        String requestId="";
		ACUMOSLogConstants.setDefaultMDCs();
		if(requestIdName!=null && !"".equals(requestIdName)) {
